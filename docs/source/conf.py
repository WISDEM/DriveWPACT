...
extensions = ['sphinx.ext.autodoc', 'sphinx.ext.mathjax', 'sphinx.ext.viewcode',
              'sphinx.ext.autosummary', 'exts.numfig', 'sphinx.ext.intersphinx', 'sphinx.ext.todo', #]
              'sphinxcontrib.bibtex', 'numpydoc', 'sphinxcontrib.zopeext.autointerface'] # added via downloads
